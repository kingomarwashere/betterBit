...
namespace
{
    ...
    QString cleanTorrentName(const QString &rawName)
    {
        ...
        // Lookbehind/ahead avoids touching e.g. "U.S.A" but those are rare in torrent names
        ...
        // This handles scene releases: "Movie Name 2008 1080p BluRay x264-GRP" → "Movie Name 2008"
